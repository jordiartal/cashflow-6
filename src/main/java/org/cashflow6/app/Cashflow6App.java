package org.cashflow6.app;

import org.cashflow6.app.config.Constants;
import org.cashflow6.app.config.JHipsterProperties;
...
public class Cashflow6App {

    private static final Logger log = LoggerFactory.getLogger(Cashflow6App.class);

    @Inject
    private Environment env;

    /**
     * Initializes cashflow6.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(Cashflow6App.class);
