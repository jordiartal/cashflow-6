...
class StockGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Stock entity")
        ...
        .repeat(2) {
            ...
            .post("/api/stocks")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "ticker":"SAMPLE_TEXT", "companyName":"SAMPLE_TEXT", "actualShares":"0", "newShares":"0", "initialDate":"2020-01-01T00:00:00.000Z", "actualValue":null, "initialValue":null, "newValue":null, "initialShares":"0"}""")).asJSON
            .check(status.is(201))
